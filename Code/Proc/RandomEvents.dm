...
RandomEvent
	...
	Class
		...
		beepType = 2
		start()
			var/spell = pick(spellList ^ list(/mob/Spells/verb/Avada_Kedavra, /mob/Spells/verb/Expecto_Patronum, /mob/Spells/verb/Lumos, /mob/Spells/verb/Lumos_Maxima, /mob/Spells/verb/Nox , /mob/Spells/verb/Self_To_Dragon, /mob/Spells/verb/Self_To_Human, /mob/Spells/verb/Episky, /mob/Spells/verb/Inflamari))
...
obj/items/scroll/prize
	...
	wlable = 0
	name = "Prize Ticket"
	content = "<body bgcolor=black><u><font color=blue size=3><b>Prize Ticket</b></u></font><br><p><font color=white size=2>Turn this scroll over to an admin+ to recieve a prize decided by the admin+.</font></p></body>"
